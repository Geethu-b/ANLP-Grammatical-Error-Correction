...
p, r, f1,dic_g_s,dic_c_s = levenshtein_report.batch_multi_pre_rec_f1(system_sentences, source_sentences, gold_edits, max_unchanged_words, beta, ignore_whitespace_casing, verbose, very_verbose)

print("Precision   : %.4f" % p)
print("Recall      : %.4f" % r)
print("F_%.1f       : %.4f" % (beta, f1))
print("Summary Gold: {}".format(dic_g_s))
print("Summary Cor.: {}".format(dic_c_s))